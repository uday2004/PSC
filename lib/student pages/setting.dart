...
class PSCSettings extends StatefulWidget {
  const PSCSettings({Key? key}) : super(key: key);
        ...
        children: [
          StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
            ...
            builder: (context, snapshot) {
              ...
              // Retrieve the fields from userData safely
              ...
              final subjects = List<String>.from(userData['Subject'] ?? []);
              final subjectText = subjects.isEmpty ? 'None' : subjects.join(', ');
              ...
              return Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 10),
                  Text("Subjects: $subjectText", style: const TextStyle(fontSize: 18)),
                  const SizedBox(height: 10),
                ],
              );
            },
